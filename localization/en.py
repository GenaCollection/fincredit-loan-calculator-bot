...
💳 Payment: {payment:,.0f} $/month""",
    ...
    "btn_loan_back_list": "📊 Back to list",
    ...
    "add_payment_prompt_month": "📅 Enter month number (1 = first month):",
    "add_payment_saved": "✅ Payment {amount:,.0f} $ for month {month} added. Schedule and totals recalculated.",
    "add_payment_cancelled": "❌ Adding payment cancelled.",

    # Edit Loan
    "edit_loan_title": """✏️ *Edit Loan* — {name}
...
Choose what you want to change:""",
    ...
    "btn_edit_rate": "📈 Rate",
    "btn_edit_term": "📅 Term",
    "edit_name_prompt": "📝 Enter new *name* for the loan:",
    "edit_amount_prompt": "💰 Enter new *amount*:",
    "edit_rate_prompt": "📈 Enter new *annual rate*:",
    "edit_term_prompt": "📅 Enter new *term* in months:",
    "edit_success": "✅ Parameter \"{field}\" changed to: *{value}*",
