...
✅ Հաշվի առնել ապահովագրությունն ու միջնորդավճարները
...
Ընտրեք գործողություն:""",
    ...
    "btn_delete": "🗑️ Ջնջել",
    "btn_edit": "✏️ Փոփոխել",
    "btn_view_schedule": "📅 Մարման գրաֆիկ",
    "btn_add_extra": "💸 Լրացուցիչ վճարում",

    # Calculator
    "calc_start": """💳 *Վարկային հաշվիչ*

Եկեք հաշվարկենք Ձեր վարկը։

📝 Մուտքագրեք *վարկի գումարը* (օրինակ՝ 1000000):""",
    "calc_rate_prompt": "📈 Մուտքագրեք *տարեկան տոկոսադրույքը* (օրինակ՝ 15):",
    "calc_term_prompt": "📅 Մուտքագրեք *վարկի ժամկետը ամիսներով* (օրինակ՝ 60):",
    "calc_amount_set": "✅ Գումար՝ {amount:,.0f} ֏",
    "calc_rate_set": "✅ Տոկոսադրույք՝ {rate}%",
    ...
    "annuity_info": "_Հավասարաչափ վճարումներ ամեն ամիս_",
    "diff_info": "_Վճարումները նվազում են ժամանակի ընթացքում_",

    "calc_insurance": """💼 *Ապահովագրություն*

Վճարելու՞ եք ամսական ապահովագրություն վարկի համար:""",
...
Պլանավորո՞ւմ եք կատարել վաղաժամ մարումներ:""",
    "btn_extra_yes": "✅ Այո",
    "btn_extra_no": "❌ Ոչ",
    ...
    "calc_extra_amount": "💸 Մուտքագրեք *վաղաժամ մարման գումարը* (օրինակ՝ 10000):",
    "calc_extra_monthly": "💸 Մուտքագրեք *ամսական վաղաժամ մարման գումարը* (օրինակ՝ 10000):",

    "calc_reduction_type": "🎯 *Ինչպե՞ս կիրառել վաղաժամ մարումը:*",
    "btn_reduce_payment": "📉 Նվազեցնել վճարը",
    "btn_reduce_term": "⏱ Նվազեցնել ժամկետը",
    "reduce_payment_info": "_Ժամկետը մնում է նույնը, վճարը նվազում է_",
    "reduce_term_info": "_Վճարը մնում է նույնը, ժամկետը կրճատվում է_",
...
🎯 Եղանակ՝ {reduction}""",
    ...
    "results_monthly": "💵 Ամսական վճար՝ {payment:,.0f} ֏",
    ...
    "results_saved_months": "⚡️ Խնայված ժամանակ՝ {saved} ամիս",
...
Դիտելու համար օգտագործեք \"📊 Իմ վարկերը\": """,
...
📈 Տոկոսադրույք՝ {rate}%
📅 Ժամկետ՝ {months} ամիս
💳 Վճար՝ {payment:,.0f} ֏/ամիս""",

    "loan_menu_title": "⚙️ *Վարկի կառավարում*",
    "btn_loan_schedule": "📅 Մարման գրաֆիկ",
    "btn_loan_add_payment": "💸 Ավելացնել վճարում",
    "btn_loan_back_list": "📊 Վերադառնալ ցանկին",

    "schedule_title": "📅 *Մարման գրաֆիկ* — {name}",
    "schedule_header": "№ | Ամսաթիվ | Վճար | Մայր գումար | % | Մնացորդ",
    ...
    "add_payment_saved": "✅ {amount:,.0f} ֏ վճարումը {month}-րդ ամսվա համար ավելացված է։ Գրաֆիկը և արդյունքները վերահաշվարկված են։",
    "add_payment_cancelled": "❌ Վճարման ավելացումը չեղարկված է։",

    # Edit Loan
    "edit_loan_title": """✏️ *Վարկի խմբագրում* — {name}

Ընտրեք, թե ինչ եք ուզում փոխել:""",
    "btn_edit_name": "📝 Անվանում",
    "btn_edit_amount": "💰 Գումար",
    "btn_edit_rate": "📈 Տոկոսադրույք",
    "btn_edit_term": "📅 Ժամկետ",
    "edit_name_prompt": "📝 Մուտքագրեք վարկի նոր *անվանումը*:",
    "edit_amount_prompt": "💰 Մուտքագրեք վարկի նոր *գումարը*:",
    ...
    "settings_reminder_days": "📅 Վճարումից {days} օր առաջ",
    ...
    "btn_lang_en": "🇬🇧 English",
    "btn_lang_hy": "🇦🇲 Հայերեն",
    "language_changed": "✅ Լեզուն փոխվել է՝ {lang}",

    "reminders_on": "✅ Հիշեցումները միացված են",
    "reminders_off": "❌ Հիշեցումները անջատված են",
...
• Անուիտետային կամ դիֆերենցված վճարներով
• Ապահովագրությամբ
• Վաղաժամ մարումներով (մեկանգամյա/պարբերական/ամսական)
• Մարման ռազմավարությամբ (նվազեցնել վճարը/ժամկետը)

📊 *Իմ վարկերը* - Պահպանված վարկերի ցանկ
⚙️ *Կարգավորումներ* - Լեզու և ծանուցումներ
🔔 *Հիշեցումներ* - Բոտը կհիշեցնի վճարումների մասին""",

    # Errors
    "error_invalid_amount": "❌ Սխալ գումար։ Մուտքագրեք 0-ից մեծ թիվ:",
    "error_invalid_rate": "❌ Սխալ տոկոսադրույք։ Մուտքագրեք 0-ից 100 թիվ:",
    "error_invalid_term": "❌ Սխալ ժամկետ։ Մուտքագրեք 1-ից 600 թիվ:",
    "error_invalid_number": "❌ Սխալ ձևաչափ։ Մուտքագրեք թիվ:",
    "error_generic": "❌ Տեղի է ունեցել սխալ։ Փորձեք մի փոքր ուշ:",
    ...
    # Reduction types
    "reduction_payment": "Նվազեցնել վճարը",
